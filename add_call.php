...
<?php include('./side.php');?>   
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST"  id="submitBrandForm" action="php_action/create_Brand.php" enctype="multipart/form-data">
                                   ...
                                   <input type="hidden" name="currnt_date" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text"  class="form-control"id="brandName" placeholder="Name" name="brandName"  required="" pattern="^[a-z A-z]+$"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-9">
            <input type="tel" class="form-control" id="brandActive" name="brandActive" pattern="\d{10}" maxlength="10" required>
        </div>
    </div>
</div>
<div class="form-group">
