...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
            <h3 class="text-primary">Leads List</h3> 
                <!-- <a href="export-leads.php" class="btn btn-success">Export to Excel</a> -->
                <div class="table-responsive m-t-40" style="overflow-y: scroll; height: 500px;">
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            // Fetch leads data and order by id in descending order
