        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Import Data</h3> </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                   <form class="form-horizontal" id="submitImportForm" action="php_action/create_BrandImport.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                 ...
                                                 <a href="assets/import/spark.xlsx" download>Sample file</a>
                                                </div>
                                            </div>
                                        </div>
