...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">View Non Motor General Insurance Customers</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">View Non Motor General Insurance</li>
            </ol>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive m-t-40" style="overflow-y: scroll; height: 500px;">
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM `customers` WHERE plan=4";
