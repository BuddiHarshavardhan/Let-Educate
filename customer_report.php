    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-title">
                        <h4 style="color:green">YTD Customers Per Plan (Total: <?php echo $totalYTD; ?>)</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-title">
                        <h4 style="color:green">Monthly Customers Per Plan (Total: <?php echo $totalMonthly; ?>)</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-title">
                        <h4 style="color:green">Daily Customers Per Plan (Total: <?php echo $totalDaily; ?>)</h4>
                    </div>
                    <div class="card-body">
