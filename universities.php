...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Add New university</h3>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="input-states">
                            ...
                            <form class="form-horizontal" id="submitCourseForm" action="php_action/createuniversity.php" method="POST">
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-sm-3 control-label">University Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="name" placeholder="Enter University name" name="name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-sm-3 control-label">Hostel Fee</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="hostel_fee" placeholder="Enter Hostel Fee" name="hostel_fee" required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table id="myTable" class="table table-bordered table-striped">
                                ...
                                <tbody id="courseTableBody">
                                    ...
                                    foreach ($result as $row) {
                                        ...
                                        echo "<td>
                                                <a href='edituniversity.php?id={$row['id']}'>
                                                    <button type='button' class='btn btn-xs btn-primary'>
                                                        <i class='fa fa-pencil'></i>
                                                    </button>
                                                </a>
                                                <a href='php_action/removeuniversity.php?id={$row['id']}' onclick='return confirm(\"Are you sure to delete this record?\")'>
...
$(document).ready(function() {
    ...
    $("#submitCourseForm").on('submit', function(event) {
        ...
        $.ajax({
            url: 'php_action/createuniversity.php', // URL to submit to
            type: 'POST',
            data: formData,
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    var newRow = "<tr>" +
                        ...
                        "<td>" + response.data.hostel_fee + "</td>" +
                        "<td>" +
                        "<a href='edituniversity.php?id=" + response.data.id + "'>" +
                        "<button type='button' class='btn btn-xs btn-primary'><i class='fa fa-pencil'></i></button>" +
                        "</a> " +
                        "<a href='php_action/removeuniversity.php?id=" + response.data.id + "'>" +
