...
$sql="SELECT * from `lead` where  id='".$_GET['id']."'";
  $result=$connect->query($sql)->fetch_assoc();  ?>    
    ...
    <select class="form-control" id="categoriesName" name="interest" required>
        <option value="">~~SELECT ~~</option>
        <option value="Health Insurance" <?php echo ($result['interest'] == 'Health Insurance') ? 'selected' : ''; ?>>Health Insurance</option>
        <option value="Life Insurance" <?php echo ($result['interest'] == 'Life Insurance') ? 'selected' : ''; ?>>Life Insurance</option>
        <option value="Motor Insurance" <?php echo ($result['interest'] == 'Motor Insurance') ? 'selected' : ''; ?>>Motor Insurance</option>
        <option value="Non Motor" <?php echo ($result['interest'] == 'Non Motor') ? 'selected' : ''; ?>>Non Motor</option>
        <option value="SIPS" <?php echo ($result['interest'] == 'SIPS') ? 'selected' : ''; ?>>SIPS</option>
        <option value="Loans" <?php echo ($result['interest'] == 'Loans') ? 'selected' : ''; ?>>Loans</option>
        <option value="Credit cards" <?php echo ($result['interest'] == 'Credit cards') ? 'selected' : ''; ?>>Credit cards</option>
    </select>
</div>

                                        <div class="form-group col-md-6">
                                            <label class="control-label">Date</label>
                                            <input type="date"  class="form-control"id="date" placeholder="City" name="date"  value="<?php echo $result['date'];  ?>" required="" />
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text"  class="form-control"id="requirement" placeholder="Requirement" name="requirement"  value="<?php echo $result['requirement'];  ?>"  >
                                        </div>
