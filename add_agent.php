...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty($errors)) {
        $sql = "INSERT INTO `agents` (`agentCode`, `name`, `phone`, `alt_phone`, `email`, `dob`, `address`, `companyName`, `doj`, `aadhar`, `pan`, `photo`, `bank`, `edu`) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="input-states">
                            <form class="row" method="POST" id="submitAgentForm" action="add_agent.php" enctype="multipart/form-data">
