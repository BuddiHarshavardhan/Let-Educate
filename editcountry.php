                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST"  id="submitBrandForm" action="php_action/editCountry.php?id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <!--<input type="number" class="form-control" id="brandStatus" name="brandStatus" value="1">-->
                                                 <input type="text" class="form-control" id="visa_fee" name="visa_fee" value="<?php echo $result['visa_fee']?>">
