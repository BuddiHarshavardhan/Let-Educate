...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">View Health Insurance Customers</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">View Health Insurance</li>
            </ol>
        </div>
    </div>
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="padding:40px" >Product_Name</th>
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM `customers` WHERE plan=1";
...
?>
<td><?php echo htmlspecialchars($formattedStartDate); ?></td>                                    <td><?php echo htmlspecialchars($row['insurer']); ?></td>
<td><?php echo htmlspecialchars($row['pro']); ?></td>
